<?php /*a:3:{s:71:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\teachers\add.html";i:1570682472;s:70:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\meta.html";i:1570605320;s:72:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\footer.html";i:1569577119;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<article class="Hui-admin-page-container">
		<form class="form form-horizontal" id="form-article-add">
			...
			<div class="row clearfix">
				...
				<div class="form-controls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="" placeholder="" id="teacherlevel" name="teacherlevel">
				</div>
			</div>
			<div class="row clearfix">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>研究方向：</label>
				<div class="form-controls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="" placeholder="" id="teacherdirection" name="teacherdirection">
				</div>
			</div>
			<div class="row clearfix">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>教师介绍：</label>
				<div class="form-controls col-xs-8 col-sm-9">
					<textarea cols="" rows="" class="textarea textarea-article"  placeholder="说点什么...最少输入10个字符" name="teacherdescription"></textarea>
				</div>
			</div>
			<div class="row clearfix">
<!--				<label class="form-label col-xs-4 col-sm-2">缩略图：</label>
			...
			<div class="row clearfix">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
					<button class="btn btn-primary radius" type="submit" id="teacheradd"><i class="Hui-iconfont">&#xe632;</i> 提交</button>
	...
	<script type="text/javascript">
		$(function () {
            $('#teacheradd').click(function () {
                $.ajax({
					url:"<?php echo url('admin/teachers/add'); ?>",
					type:"post",
