<?php /*a:4:{s:76:"/www/wwwroot/huyangWeb/application/index/view/chhcollege/activity/index.html";i:1572677422;s:69:"/www/wwwroot/huyangWeb/application/index/view/public/coll_header.html";i:1572677422;s:69:"/www/wwwroot/huyangWeb/application/index/view/public/coll_leftBy.html";i:1572677422;s:69:"/www/wwwroot/huyangWeb/application/index/view/public/coll_footer.html";i:1572677422;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head runat="server">
...
<div class="pageBanner">
    <div class="roll flexslider">
        <ul class="slides">
            <li><img src="/static/chhcollege/picture/20190923163925.jpg"></li>
        </ul>
    </div>
    <div class="txt">
        <div class="cw">
            ...
            <div class="rightBy fr">
                <div class="tool clearfix">
                    ...
                    <div class="fr"><a href="<?php echo url('index/index'); ?>" target="_blank">首页</a><span class="cur">></span><a
                            href="javascript:;" class="cur">平台活动</a></div>
                </div>
                <div class="activity">
                    <ul class="ullist">
                        <?php if(is_array($all_activity) || $all_activity instanceof \think\Collection || $all_activity instanceof \think\Paginator): $i = 0; $__LIST__ = $all_activity;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <li>
                            <div class="item">
                                <a href="<?php echo url('index/act_detail',['activityId'=>$vo['activityId']]); ?>" class="pic"><img
                                        src="<?php echo htmlentities($vo['activity_pic']); ?>"></a>
