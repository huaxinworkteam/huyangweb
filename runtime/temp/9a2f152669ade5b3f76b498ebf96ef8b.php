<?php /*a:4:{s:85:"D:\phpstudy\PHPTutorial\WWW\tp\application\index\view\chhcollege\activity\detail.html";i:1570781162;s:77:"D:\phpstudy\PHPTutorial\WWW\tp\application\index\view\public\coll_header.html";i:1570845055;s:77:"D:\phpstudy\PHPTutorial\WWW\tp\application\index\view\public\coll_leftBy.html";i:1570689647;s:77:"D:\phpstudy\PHPTutorial\WWW\tp\application\index\view\public\coll_footer.html";i:1570845820;}*/ ?>
﻿<!DOCTYPE HTML>
<html>

<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"> <title>扬帆起航，成就卓越 | 创合汇 「独角兽」创业成长计划三期开学典礼成功举办！</title>
<meta name='keywords' content="创合汇商学院——全球开放式平台型商学院" />
<meta name='description' content="2019年3月23日，创合汇「独角兽」创业成长计划三期的学员们开启了他们学习、成长、蜕变的新征程。此次学习之旅让创业者携手同行，在创业征途中成为时代的主角！" />
...
<script type="text/javascript">
    ...
    <div class="pageBanner">
        <div class="roll flexslider">
            <ul class="slides">
                <li><img src="/static/chhcollege/picture/20171124154221.jpg"></li>            </ul>
        </div>
        <div class="txt">
            <div class="cw">
                <h3></h3>
    ...
    <div class="page">
        ...
        <div class="bottom"></div>
                ...
                <div class="rightBy fr">
                    ...
                    <div class="activity">
                        <div class="back"> <a href="javascript:history.go(-1)">返回<em>&gt;&gt;</em></a> </div>
                        <div class="content">
                            <h3><?php echo htmlentities($act_id['activityTitle']); ?></h3>
                            <h4><?php echo htmlentities($act_id['createTime']); ?></h4>
                            <h4><?php echo $act_id['articleContent']; ?></h4>
                         </div>

                       <!-- 有效时间 0为过期 1为有效-->
                        <div class="bottom">  <a class="off"><?php if($act_id['outofdate']==0): ?>活动已过期<?php else: ?>活动进行中<?php endif; ?></a>  </div>
                    </div>
                </div>
                <!--right End-->
            </div>
