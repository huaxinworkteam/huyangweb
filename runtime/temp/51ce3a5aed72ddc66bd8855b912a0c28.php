<?php /*a:3:{s:72:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\activity\edit.html";i:1570700527;s:70:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\meta.html";i:1570605320;s:72:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\footer.html";i:1569577119;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<form class="form form-horizontal" id="form-article-add" >
			<div class="row clearfix">
				...
				<div class="form-controls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="<?php echo htmlentities($activityinfo['activityTitle']); ?>" placeholder="" id="articleTitle" name="articleTitle">
					<input type="hidden" name="activityId" value="<?php echo htmlentities($activityinfo['activityId']); ?>" />
				</div>
			</div>
		<!--	<div class="row clearfix">
...
<!--			<div class="row clearfix">
			...
			<div class="row clearfix">
				...
				<div class="form-controls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="<?php echo htmlentities($activityinfo['articleKey']); ?>" placeholder="" id="articleKey" name="articleKey">
				</div>
			</div>
			<div class="row clearfix">
				...
				<input type="checkbox" id="isShow" name="isShow" onclick="check_box(value);" value="<?php echo htmlentities($activityinfo['isShow']); ?>" <?php if($activityinfo['isShow'] == 1): ?>checked<?php endif; ?>>
			</div>
			<!--<div class="row clearfix">
			...
			<div class="form-controls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo htmlentities($activityinfo['writer']); ?>" placeholder="" id="articleAuthor" name="articleAuthor">
			</div>
		</div>
			<div class="row clearfix">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>当前封面：</label>
				<div class="form-controls col-xs-8 col-sm-9">
					<img src="<?php echo htmlentities($activityinfo['activity_pic']); ?>" alt="封面" width="250px" height="200px" >
				</div>
			</div>
			<div class="row clearfix">
		...
		<!--	<div class="row clearfix">
			...
			<div class="row clearfix">
				...
				<div class="form-controls col-xs-8 col-sm-9">
					<textarea id="content" name="content" type="text/plain" style="width:100%;height:400px;" ><?php echo htmlentities($activityinfo['articleContent']); ?></textarea>
				</div>
			</div>
			<div class="row clearfix">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
					<button class="btn btn-primary radius" id="activityEdit" type="submit"><i class="Hui-iconfont">&#xe632;</i> 提交</button>
...
/*			$("#comment-datetime-start").datetimepicker({
	...
	/*		$(".textarea-article").Huitextarealength({
			...
			$('#activityEdit').click(function () {
					...
					$.ajax(
						{
							url:"<?php echo url('admin/activity/activityedit'); ?>",
							type:'post',
	...
	<script type="text/javascript">
        var SCOPE = {
            ...
            'url' : "<?php echo url('admin/Activity/fileUpload'); ?>",
        };
        ...
        $(function() {
            ...
            uploader.on( 'uploadSuccess', function( file ,response) {
                ...
                $("#InputsWrapper").append('<input type="hidden"  name="activity_pic" id="'+picId+'" value="'+response+'"/>');
