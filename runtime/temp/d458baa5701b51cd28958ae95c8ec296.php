<?php /*a:3:{s:69:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\admin\edit.html";i:1571134137;s:70:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\meta.html";i:1570605320;s:72:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\footer.html";i:1569577119;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<form class="form form-horizontal" id="form-admin-add">
			...
			<div class="row clearfix">
				...
				<div class="form-controls col-xs-8 col-sm-9">
					...
					<input type="text" class="input-text"  value="<?php echo htmlentities($admin['nickname']); ?>" placeholder="" id="nickname" name="nickname">
				</div>
			</div>
			<div class="row clearfix">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>账号：</label>
				<div class="form-controls col-xs-8 col-sm-9">
					<input type="text" class="input-text" placeholder="" value="<?php echo htmlentities($admin['username']); ?>" id="username" name="username">
				</div>
			</div>
			<div class="row clearfix">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>初始密码：</label>
				<div class="form-controls col-xs-8 col-sm-9">
					<input type="password" class="input-text" autocomplete="off" value="<?php echo htmlentities($admin['password']); ?>" placeholder="密码" id="password" name="password">
				</div>
			</div>
			<div class="row clearfix">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>确认密码：</label>
				<div class="form-controls col-xs-8 col-sm-9">
					<input type="password" class="input-text" autocomplete="off" value="<?php echo htmlentities($admin['password']); ?>" placeholder="确认新密码" id="password2" name="password2">
				</div>
			</div>
			<div class="row clearfix">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>手机：</label>
				<div class="form-controls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="<?php echo htmlentities($admin['phone']); ?>" placeholder="" id="phone" name="phone">
				</div>
			</div>
			<div class="row clearfix">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>邮箱：</label>
				<div class="form-controls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="<?php echo htmlentities($admin['email']); ?>" placeholder="@" name="email" id="email">
				</div>
			</div>
			<div class="row clearfix">
			...
			<div class="row clearfix">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
					<input class="btn btn-primary radius" id="adminedit" type="submit" value="&nbsp;&nbsp;保存&nbsp;&nbsp;">
				</div>
			</div>
		</form>
	</article>
