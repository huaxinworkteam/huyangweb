<?php /*a:3:{s:72:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\teachers\edit.html";i:1571134138;s:70:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\meta.html";i:1570605320;s:72:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\footer.html";i:1569577119;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<body>
	<article class="Hui-admin-page-container">
		<form class="form form-horizontal" id="form-article-add">
			<input type="hidden" name="teacherid" value="<?php echo htmlentities($teacherinfo['teacherid']); ?>" />
			<div class="row clearfix">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>教师姓名：</label>
				<div class="form-controls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="<?php echo htmlentities($teacherinfo['teachername']); ?>" placeholder="" id="teachername" name="teachername">
				</div>
			</div>
			<div class="row clearfix">
				...
				<input type="checkbox" id="isShow" name="isShow" onclick="check_box(value)" value="<?php echo htmlentities($teacherinfo['isShow']); ?>" <?php if($teacherinfo['isShow'] == 1): ?>checked<?php endif; ?>>
			</div>
			<div class="row clearfix">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>院系：</label>
				<div class="form-controls col-xs-8 col-sm-9">
					<span class="select-box">
						<select name="seriesNO" class="select">
							...
							<option value="<?php echo htmlentities($vo['seriesID']); ?>"><?php echo htmlentities($vo['series']); ?></option>
			...
			<div class="row clearfix">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>教师等级：</label>
				<div class="form-controls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="<?php echo htmlentities($teacherinfo['teacherlevel']); ?>" placeholder="" id="teacherlevel" name="teacherlevel">
				</div>
			</div>
			<div class="row clearfix">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>研究方向：</label>
				<div class="form-controls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="<?php echo htmlentities($teacherinfo['teacherdirection']); ?>" placeholder="" id="teacherdirection" name="teacherdirection">
				</div>
			</div>
			<div class="row clearfix">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>当前封面：</label>
				<div class="form-controls col-xs-8 col-sm-9">
					<img src="<?php echo htmlentities($teacherinfo['teacherphoto']); ?>" alt="封面" width="250px" height="200px" >
				</div>
			</div>
			<div class="row clearfix">
			...
			<div class="row clearfix">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>教师介绍：</label>
				<div class="form-controls col-xs-8 col-sm-9">
					<textarea cols="" rows="" class="textarea textarea-article"  placeholder="说点什么...最少输入10个字符" name="teacherdescription"><?php echo htmlentities($teacherinfo['teacherdescription']); ?></textarea>
				</div>
			</div>
			...
			<div class="row clearfix">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
					<button class="btn btn-primary radius" type="submit" id="teacheredit"><i class="Hui-iconfont">&#xe632;</i> 保存</button>
...
<script>
	...
	<script type="text/javascript">
        var SCOPE = {
            ...
            'url' : "<?php echo url('admin/WebuploadController/fileUpload'); ?>",
        };
        ...
        $(function() {
            ...
            uploader.on( 'uploadSuccess', function( file ,response) {
                ...
                $("#InputsWrapper").append('<input type="hidden"  name="teacherphoto" id="'+picId+'" value="'+response+'"/>');
	...
	<script type="text/javascript">
		$(function () {
            $('#teacheredit').click(function () {
                $.ajax({
					url:"<?php echo url('admin/teachers/edit'); ?>",
					type:"post",
