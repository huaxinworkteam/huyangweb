<?php /*a:5:{s:68:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\admin\all.html";i:1571135961;s:70:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\meta.html";i:1570605320;s:73:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\leftbar.html";i:1571136188;s:72:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\header.html";i:1570464902;s:72:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\footer.html";i:1569577119;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
        ...
        <article class="Hui-admin-content clearfix">
            <div class="panel">
                <div class="panel-body">
                    <form action="<?php echo url('admin/adminsearch'); ?>" method="get">
                    <div class="text-c">
                    ...
                    <div class="mt-20 clearfix">
                        <table class="table table-border table-bordered table-bg table-hover table-sort">
                            ...
                            <tr class="text-c">
                                ...
                                <?php if(session('admin.is_super')==1): ?><th width="100">操作</th><?php endif; ?>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            <tr class="text-c">
                                <td><input type="checkbox"  value="<?php echo htmlentities($vo['id']); ?>" class="ckc"></td>
                                ...
                                <td class="td-status"><span class="label label-success radius"><?php if($vo['status']==1): ?>已启用<?php else: ?>已禁用<?php endif; ?></span>
                                </td>
                                <?php if(session('admin.is_super')==1): ?>
                                <td class="td-manage">
                                   <a style="text-decoration:none" onClick="<?php if($vo['status']==1): ?>admin_stop(this,<?php echo htmlentities($vo['id']); ?>)<?php else: ?>admin_start(this,<?php echo htmlentities($vo['id']); ?>)<?php endif; ?>"
                                                         href="javascript:;" title="停用"><i
                                        class="Hui-iconfont">&#xe631;</i></a> <a title="编辑" href="javascript:;"
                                                                                 onclick="admin_role_edit('管理员编辑', 'adminedit', <?php echo htmlentities($vo['id']); ?>)"
                                                                                 class="ml-5"
                                                                                 style="text-decoration:none"><i
                                        class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;"
                                                                                 onclick="admin_del(this,<?php echo htmlentities($vo['id']); ?>)"
                                                                                 class="ml-5"
                                                                                 style="text-decoration:none"><i
...
<script type="text/javascript">
    ...
    function datadel() {
        ...
        if(confirm("确定要删除吗")){
            $.ajax({
                url:"<?php echo url('admin/Admin/deladmin'); ?>",
