            ...
            <div class="panel mt-20">
                <div class="panel-body">
                    <div class="clearfix">
							...
							<a class="btn btn-primary radius" href="javascript:;" onclick="news_add('新闻添加','newsadd.html')"><i
                            ...
                            <tr class="text-c">
                                ...
                                <td class="f-14 td-manage">
                                    ...
                                    <a style="text-decoration:none" class="op2 ml-5"
                                       href="javascript:;" onclick="news_edit('新闻编辑','newsedit',<?php echo htmlentities($vo['newsid']); ?>)"
