<?php /*a:5:{s:73:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\activity\lists.html";i:1571137928;s:70:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\meta.html";i:1570605320;s:73:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\leftbar.html";i:1571136824;s:72:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\header.html";i:1570464902;s:72:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\footer.html";i:1569577119;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
            ...
            <div class="panel mt-20">
                <div class="panel-body">
                    <div class="clearfix">
							...
							<a class="btn btn-primary radius" href="javascript:;" onclick="activity_add('活动添加','activityadd')"><i
                    ...
                    <div class="mt-20 clearfix">
                        <table id="data-table-list"
                            ...
                            <tr class="text-c">
                                <td><input type="checkbox" class="ckc" value="<?php echo htmlentities($vo['activityId']); ?>"></td>
                                <td><?php echo htmlentities($vo['activityId']); ?></td>
                                <td class="text-l"><a style="cursor:pointer" class="text-primary"
                                                      href="<?php echo url('index/Index/act_detail',['activityId'=>$vo['activityId']]); ?>"
                                                      title="查看"><?php echo htmlentities($vo['activityTitle']); ?></a></td>
                                ...
                                <td class="f-14 td-manage">
                                    <?php if($vo['isShow'] ==1): ?><a class="op1" style="text-decoration:none" href="javascript:;"
                                                          title="下架" isShow="<?php echo htmlentities($vo['isShow']); ?>" activityId="<?php echo htmlentities($vo['activityId']); ?>"><i
                                        class="Hui-iconfont">&#xe631;</i></a>
                                    <?php else: ?><a class="op1" style="text-decoration:none" href="javascript:;" title="上架"
                                               isShow="<?php echo htmlentities($vo['isShow']); ?>" activityId="<?php echo htmlentities($vo['activityId']); ?>"><i
                                        class="Hui-iconfont">&#xe631;</i></a>
                                    <?php endif; ?>
                                    <a style="text-decoration:none" class="op2 ml-5"
                                       href="javascript:;"
                                       onclick="activity_edit('活动编辑','activityedit',<?php echo htmlentities($vo['activityId']); ?>)"
...
<script type="text/javascript">
    ...
    function datadel() {
        ...
        if(confirm("确定要删除吗")){
            $.ajax({
                url:"<?php echo url('admin/Activity/delactivity'); ?>",
