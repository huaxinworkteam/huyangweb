<?php /*a:5:{s:72:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\activity\list.html";i:1570024197;s:70:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\meta.html";i:1569578580;s:73:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\leftbar.html";i:1570500498;s:72:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\header.html";i:1570464902;s:72:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\footer.html";i:1569577119;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
    ...
    <div class="Hui-admin-menu-dropdown bk_2">
        ...
        <dl id="menu-article" class="Hui-menu">
            ...
            <dd class="Hui-menu-item">
                <ul>
                    <li><a href="<?php echo url('activity/list'); ?>" title="活动管理">活动管理</a></li>
        ...
        <dl id="menu-product" class="Hui-menu">
            ...
            <dd class="Hui-menu-item">
                <ul>
                    <li><a href="<?php echo url('news/list'); ?>" title="品牌管理">新闻管理</a></li>
            ...
            <div class="panel">
                <div class="panel-body">
                    <div class="row clearfix">
                        ...
                        <form action="<?php echo url('activity/activitysearch'); ?>" method="get">
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="row clearfix mb-10">
                                ...
                                <div class="row clearfix">
									<span class="col-xs-4 form-item-control">
										<button name="search" id="search-submit" class="btn btn-success radius"
                                                type="submit" value="activity"><i
                                                class="Hui-iconfont">&#xe665;</i> 搜活动</button>
									</span>
                                    <span class="col-xs-4 form-item-control">
										<button name="search" id="search-submit" class="btn btn-success radius"
            ...
            <div class="panel mt-20">
                <div class="panel-body">
                    <div class="clearfix">
							...
							<a class="btn btn-primary radius" href="<?php echo url('activity/add'); ?>"><i
                    ...
                    <div class="mt-20 clearfix">
                        <table id="data-table-list"
                            ...
                            <tr class="text-c">
                                ...
                                <td><?php echo htmlentities($vo['activityId']); ?></td>
                                <td class="text-l"><u style="cursor:pointer" class="text-primary"
                                                      onClick="article_edit('查看','article-add.html','10001')"
                                                      title="查看"><?php echo htmlentities($vo['activityTitle']); ?></u></td>
                                ...
                                <td class="f-14 td-manage">
                                    <?php if($vo['isShow'] ==1): ?><a class="op1" style="text-decoration:none" href="javascript:;"
                                                          title="下架" isShow="<?php echo htmlentities($vo['isShow']); ?>" activityId="<?php echo htmlentities($vo['activityId']); ?>">下架</a>
                                    <?php else: ?><a class="op1" style="text-decoration:none" href="javascript:;" title="上架"
                                               isShow="<?php echo htmlentities($vo['isShow']); ?>" activityId="<?php echo htmlentities($vo['activityId']); ?>">上架</a>
                                    <?php endif; ?>
                                    <a style="text-decoration:none" class="op2 ml-5"
                                       href="<?php echo url('admin/activity/activityedit',['activityId'=>$vo['activityId']]); ?>"
                                       title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
                                    <a style="text-decoration:none" class="op3 ml-5" activityId="<?php echo htmlentities($vo['activityId']); ?>"
                                       onClick="activity_del(this,<?php echo htmlentities($vo['activityId']); ?>)"
...
<script type="text/javascript">
    /*    function article_del(obj, id) {
            ...
            layer.confirm('确认要删除吗？', function (index) {
                layer.close(index);
                $.ajax({
                    url:"<?php echo url('admin/activity/activitydel'); ?>",
                    type:'POST',
                    data:{activityId:id},
                    dataType:'json',
                    success: function (data) {
    ...
    $(function () {
        $('.op1').click(function () {
            ...
            layer.confirm(msg, {
                ...
                layer.close(index);
                $.ajax({
                    url: "<?php echo url('admin/activity/activityshow'); ?>",
                    type: "post",
                    data: {activityId: activityId, isShow: isShow},
                    dataType: "json",
                    success: function (data) {
                        if (data.code == 1) {
                            layer.msg(data.msg, {
