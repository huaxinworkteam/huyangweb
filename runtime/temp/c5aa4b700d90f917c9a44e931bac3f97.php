<?php /*a:3:{s:71:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\activity\add.html";i:1570692105;s:70:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\meta.html";i:1570605320;s:72:"D:\phpstudy\PHPTutorial\WWW\tp\application\admin\view\Common\footer.html";i:1569577119;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<!--	<div class="row clearfix">
			...
			<div class="row clearfix">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
					<button class="btn btn-primary radius" id="activityAdd" type="submit"><i class="Hui-iconfont">&#xe632;</i> 提交</button>
...
/*			$("#comment-datetime-start").datetimepicker({
	...
	/*		$(".textarea-article").Huitextarealength({
			...
			$('#activityAdd').click(function () {
					$.ajax(
						{
							url:"<?php echo url('admin/activity/add'); ?>",
							type:'post',
