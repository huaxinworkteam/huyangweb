<?php /*a:5:{s:61:"/www/wwwroot/huyangWeb/application/admin/view/news/lists.html";i:1570884662;s:62:"/www/wwwroot/huyangWeb/application/admin/view/Common/meta.html";i:1570605320;s:65:"/www/wwwroot/huyangWeb/application/admin/view/Common/leftbar.html";i:1570849917;s:64:"/www/wwwroot/huyangWeb/application/admin/view/Common/header.html";i:1570464902;s:64:"/www/wwwroot/huyangWeb/application/admin/view/Common/footer.html";i:1569577119;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
    ...
    <div class="Hui-admin-menu-dropdown bk_2">
        ...
        <dl id="menu-article" class="Hui-menu">
            ...
            <dd class="Hui-menu-item">
                <ul>
                    <li><a href="<?php echo url('activity/lists'); ?>" title="活动管理">活动管理</a></li>
                    <li><a href="<?php echo url('activity/add'); ?>"  title="新增活动">新增活动</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-product" class="Hui-menu">
            ...
            <dd class="Hui-menu-item">
                <ul>
                    <li><a href="<?php echo url('news/lists'); ?>" title="品牌管理">新闻管理</a></li>
                    <li><a href="<?php echo url('news/add'); ?>" title="分类管理">新增新闻</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-product" class="Hui-menu">
            ...
            <dd class="Hui-menu-item">
                <ul>
                    <li><a href="<?php echo url('teachers/index'); ?>" title="教师管理">教师管理</a></li>
                    <li><a href="<?php echo url('teachers/add'); ?>" title="新增教师">新增教师</a></li>
                    <li><a href="<?php echo url('teachers/series'); ?>" title="院系管理">院系管理</a></li>
                </ul>
            </dd>
        </dl>
            ...
            <div class="panel">
                <div class="panel-body">
                    <div class="row clearfix">
                        ...
                        <form action="<?php echo url('news/newssearch'); ?>" method="get">
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="row clearfix mb-10">
                                    <span class="col-xs-4 form-item-label">标题名称：</span>
                                    <span class="col-xs-8 form-item-control">
										<input type="text" name="searchInput" value="" id="search-input"
                                               placeholder="<?php echo htmlentities($title); ?>"
                                               class="input-text"/>
									</span>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="row clearfix">
									<span class="col-xs-4 form-item-control">
										<button name="search" id="search-submit" class="btn btn-success radius"
                                                type="submit" value="news"><i
                                                class="Hui-iconfont">&#xe665;</i> 搜新闻</button>
									</span>
                                    <span class="col-xs-4 form-item-control">
										<button name="search" id="search-submit" class="btn btn-success radius"
                                                type="submit" value="writer"><i
                                                class="Hui-iconfont">&#xe665;</i> 搜作者</button>
									</span>
                                </div>
                            </div>
                        </form>
            ...
            <div class="panel mt-20">
                <div class="panel-body">
                    <div class="clearfix">
							...
							<a class="btn btn-primary radius" href="<?php echo url('news/add'); ?>"><i
                    ...
                    <div class="mt-20 clearfix">
                        <table id="data-table-list"
                            ...
                            <tr class="text-c">
                                <td><input type="checkbox" class="ckc" value="<?php echo htmlentities($vo['newsid']); ?>"></td>
                                <td><?php echo htmlentities($vo['newsid']); ?></td>
                                <td class="text-l"><a style="cursor:pointer" class="text-primary"
                                                      href="<?php echo url('index/Index/news_detail',['newsid'=>$vo['newsid']]); ?>"
                                                      title="查看"><?php echo htmlentities($vo['newstitle']); ?></a></td>
                                <td><?php echo htmlentities($vo['writer']); ?></td>
                                <td><?php echo htmlentities($vo['nickname']); ?></td>
                                <td><?php echo htmlentities($vo['createTime']); ?></td>
                                <td class="td-status"><span class="label label-success radius"><?php if($vo['isShow'] ==1): ?>已发布<?php else: ?>已下架<?php endif; ?>
                                </td>
                                <td class="f-14 td-manage">
                                    <?php if($vo['isShow'] ==1): ?><a class="op1" style="text-decoration:none" href="javascript:;"
                                                          title="下架" isShow="<?php echo htmlentities($vo['isShow']); ?>" newsid="<?php echo htmlentities($vo['newsid']); ?>"><i
                                        class="Hui-iconfont">&#xe631;</i></a>
                                    <?php else: ?><a class="op1" style="text-decoration:none" href="javascript:;" title="上架"
                                               isShow="<?php echo htmlentities($vo['isShow']); ?>" newsid="<?php echo htmlentities($vo['newsid']); ?>"><i
                                        class="Hui-iconfont">&#xe631;</i></a>
                                    <?php endif; ?>
                                    <a style="text-decoration:none" class="op2 ml-5"
                                       href="<?php echo url('admin/news/newsedit',['newsid'=>$vo['newsid']]); ?>"
                                       title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
                                    <a style="text-decoration:none" class="op3 ml-5" newsid="<?php echo htmlentities($vo['newsid']); ?>"
                                       onClick="news_del(this,<?php echo htmlentities($vo['newsid']); ?>)"
...
<script type="text/javascript">
    ...
    function datadel() {
        ...
        if(confirm("确定要删除吗")){
            $.ajax({
                url:"<?php echo url('admin/News/delnews'); ?>",
    ...
    $(function () {
            window.onload = function () {
                for ($i = 0; $i < $(".td-status span").length; $i++) {
                    if ($(".td-status span")[$i].innerText == '已下架') {
...
<script type="text/javascript">
    /*    function article_del(obj, id) {
            ...
            layer.confirm('确认要删除吗？', function (index) {
                layer.close(index);
                $.ajax({
                    url:"<?php echo url('admin/news/newsdel'); ?>",
                    type:'POST',
                    data:{newsid:id},
                    dataType:'json',
                    success: function (data) {
    ...
    $(function () {
        $('.op1').click(function () {
            ...
            layer.confirm(msg, {
                ...
                layer.close(index);
                $.ajax({
                    url: "<?php echo url('admin/news/newsshow'); ?>",
                    type: "post",
                    data: {newsid: newsid, isShow: isShow},
                    dataType: "json",
                    success: function (data) {
                        if (data.code == 1) {
                            layer.msg(data.msg, {
