<?php /*a:5:{s:80:"/www/wwwroot/huyangWeb/application/index/view/chhcollege/about/introduction.html";i:1576490654;s:62:"/www/wwwroot/huyangWeb/application/index/view/public/head.html";i:1574909810;s:69:"/www/wwwroot/huyangWeb/application/index/view/public/coll_header.html";i:1576828632;s:69:"/www/wwwroot/huyangWeb/application/index/view/public/coll_leftBy.html";i:1574734484;s:69:"/www/wwwroot/huyangWeb/application/index/view/public/coll_footer.html";i:1576828823;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head runat="server">
        ...
        <div class="bottom"></div>
            ...
            <div class="rightBy fr">
                <div class="tool clearfix">
                    ...
                    <div class="fr"><a href="<?php echo url('index/index'); ?>" target="_blank">首页</a><span class="cur">></span><a href="javascript:;"
                                                                                                   class="cur">学院介绍</a>
                    </div>
                </div>
                <div class="contBody">
                    <div class="item">
                        <a href="<?php echo url('index/personalbrand'); ?>">个人品牌学院</a>
                    </div>
                    <div class="item">
                        <a href="<?php echo url('index/financeandtax'); ?>">财税学院</a>
                    </div>
                </div>
                <!--<div class="contBody">
                    ...
                    <blockquote class="" data-author="Wxeditor"
                        ...
                        <section style="text-align: center;box-sizing: border-box !important;">
                                    ...
                                    <section
                                        ...
                                        <p style="padding: 2px 10px;font-size: 16px;color: rgb(6, 6, 6);box-sizing: border-box !important;">
                                            <span style="color: rgb(170, 117, 80);"><strong
                                                    ...
                                                    style="color: rgb(170, 117, 80);font-size: 18px;box-sizing: border-box !important;">关于</span></strong></span></strong></span></strong></span>
                                        </p>
                                        <section class=""
                            ...
                            <p style="text-align: center;"><span
                                    ...
                                    style="color: rgb(81, 79, 79);font-size: 14px;letter-spacing: 0.544px;text-align: left;background-color: rgb(255, 255, 255);">是基于上海交通大学等国内外知名院校优质资源的基础上成立的全球新一代平台型商学院。</span></span>
                            </p>
                            <p style="text-align: center;"><span
                                    style="color: rgb(81, 79, 79);font-size: 14px;line-height: 1.6;box-sizing: border-box !important;"><span
